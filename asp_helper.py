                    ...
                    if ').' in line:
                        ...
                        for i in range(len(predicates) - 1):
                            ...
                            if split[0] == "vertex":
                                ...
                                if len(split) != 3:
                                    print('WARN!\tEdge not recognized in line ' + str(count_line) + ': ' + predicates[i])
                                    result = -1
                                    continue
                                
                                if not validate_input_name(split[0]) or not validate_input_name(split[1]):
                                    print('WARN!\tInvalid node argument in line ' + str(count_line) + ': ' + predicates[i])
                                ...
                                try:
                                    ...
                                    print('WARN!\tInvalid edge sign: ' + split[2] + ' on line ' + str(count_line) + ' in edge ' + predicates[i])
                                    return -2
                                
                                if sign not in [0, 1]:
                                    print('WARN!\tInvalid edge sign on line ' + str(count_line) + ' in edge ' + predicates[i])
                                    return -2
                                ...
                                if len(split) != 2:
                                    print('WARN!\tfunctionOr not recognized on line ' + str(count_line) + ': ' + predicates[i])
                                    result = -1
                                    continue
                            ...
                            #     if not Util_h.validate_input_name(split[0]) or not Util_h.validate_input_name(split[1]):
                            ...
                            #     if not Util_h.validate_input_name(split[0]) or not Util_h.validate_input_name(split[2]):
                            ...
                            #     node.get_function().add_element_clause(clause_id, split[2])
                            #     continue
        except IOError:
